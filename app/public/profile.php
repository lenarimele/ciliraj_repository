    ...
    <div class="row justify-content-center">
      <div class="col-sm-12 col-md-6 col-lg-4">
        <div class="card shadow-sm">
          <div class="card-body">
            <h4 class="text-center mb-4">Ustvari račun</h4>
  
            <form>
              <div class="mb-3">
                <input type="email" class="form-control border bg-light" id="email" placeholder="Elektronska pošta" required>
              </div>
              <div class="mb-3">
                <input type="text" class="form-control border bg-light" id="username" placeholder="Uporabniško ime" required>
              </div>
              <div class="mb-3">
                <input type="password" class="form-control border bg-light" id="password" placeholder="Geslo" required>
                <div class="form-text">Geslo mora vsebovati minimalno 8 znakov in vsaj en poseben znak (*#!,...)</div>
              </div>
  
              <div class="d-grid">
                <button type="submit" class="btn btn-danger">Ustvari račun</button>
              </div>
            </form>
